...
async function main() {
  ...
  await prisma.compounds.createMany({
    data: [
      // القاهرة الجديدة (city_id: 1)
      { id: 1, city_id: 1, area_id: 2, name_ar: "مدينتي", name_en: "Madinaty" },
      { id: 2, city_id: 1, area_id: 1, name_ar: "الرحاب", name_en: "Al Rehab" },
      {
        id: 3,
        city_id: 1,
        area_id: 1,
        name_ar: "ماونتن فيو آي سيتي",
      ...
      { id: 6, city_id: 1, area_id: 1, name_ar: "ميفيدا", name_en: "Mivida" },
      {
        id: 7,
        city_id: 1,
        area_id: 1,
      ...
      { id: 20, city_id: 1, area_id: 1, name_ar: "ساراي", name_en: "Sarai" },
      {
        id: 21,
        city_id: 1,
        area_id: 1,
      ...
      { id: 26, city_id: 1, area_id: 1, name_ar: "فيرن", name_en: "Vern" },
      {
        id: 27,
        city_id: 1,
        area_id: 1,
      ...
      { id: 29, city_id: 1, area_id: 1, name_ar: "كيستو", name_en: "Kesto" },
      { id: 30, city_id: 1, area_id: 1, name_ar: "برو", name_en: "Brew" },
      ...
      { id: 49, city_id: 57, area_id: null, name_ar: "روف", name_en: "Rove" },
      {
        id: 50,
        city_id: 57,
        area_id: null,
      ...
      { id: 56, city_id: 60, area_id: 3, name_ar: "بلڤا", name_en: "Belva" },
      {
        id: 57,
        city_id: 60,
        area_id: 3,
      ...
      { id: 58, city_id: 60, area_id: 3, name_ar: "فاي", name_en: "VYE" },
      {
        id: 59,
        city_id: 60,
        area_id: 3,
      ...
      { id: 61, city_id: 60, area_id: 3, name_ar: "جوار", name_en: "Jewar" },
      { id: 62, city_id: 60, area_id: 3, name_ar: "جيدار", name_en: "Jedar" },
      { id: 63, city_id: 60, area_id: 3, name_ar: "جيرا", name_en: "Jeera" },
      { id: 64, city_id: 60, area_id: 3, name_ar: "إيتابا", name_en: "Etapa" },
      { id: 65, city_id: 60, area_id: 3, name_ar: "كاسا", name_en: "Casa" },
      {
        id: 66,
        city_id: 60,
        area_id: 3,
      ...
      // 6 أكتوبر (city_id: 59)
      {
        ...
        city_id: 59,
        area_id: null,
        name_ar: "ماونتن فيو آي سيتي أكتوبر",
      ...
      },
      {
        ...
        city_id: 350,
        area_id: null,
        name_ar: "ماونتن فيو رأس الحكمة",
        name_en: "Mountain View Ras El Hekma",
      },
      { id: 81, city_id: 350, area_id: null, name_ar: "سول", name_en: "Soul" },
      {
        id: 82,
        city_id: 350,
        area_id: null,
      ...
      { id: 87, city_id: 21, area_id: 4, name_ar: "تيزان", name_en: "Tijan" },
      {
        id: 88,
        city_id: 21,
        area_id: 4,
      ...
      { id: 94, city_id: 23, area_id: 5, name_ar: "9 سايد", name_en: "9 Side" },
  ...
  await prisma.categories.createMany({
    data: [
      { id: 1, type: "VACATION", name_en: "Villa", name_ar: "فيلا" },
      { id: 2, type: "VACATION", name_en: "Chalet", name_ar: "شاليه" },
      { id: 3, type: "VACATION", name_en: "Apartment", name_ar: "شقة" },
      { id: 4, type: "VACATION", name_en: "Studio", name_ar: "استوديو" },
      {
        id: 5,
        type: "VACATION",
        name_en: "Hotel Room",
      ...
      { id: 6, type: "VACATION", name_en: "Duplex", name_ar: "دوبلكس" },
      { id: 7, type: "VACATION", name_en: "Penthouse", name_ar: "بنتهاوس" },
    ],
    skipDuplicates: true,
  });
  await prisma.subCategories.createMany({
    data: [
      // Villa
      { id: 1, name_en: "Luxury Villa", name_ar: "فيلا فاخرة", category_id: 1 },
      {
        id: 2,
        name_en: "Standard Villa",
        name_ar: "فيلا عادية",
        category_id: 1,
      },
      ...
      {
        id: 3,
        name_en: "Beachfront Chalet",
        name_ar: "شاليه على البحر",
        category_id: 2,
      },
      {
        id: 4,
        name_en: "Garden Chalet",
        name_ar: "شاليه بحديقة",
        category_id: 2,
      },
      ...
      // Apartment
      {
        ...
        name_ar: "شقة على البحر",
        category_id: 3,
      },
      {
        id: 6,
        name_en: "Family Apartment",
        name_ar: "شقة عائلية",
        category_id: 3,
      },
      ...
      {
        id: 7,
        name_en: "Budget Studio",
        name_ar: "استوديو اقتصادي",
        category_id: 4,
      },
      {
        id: 8,
        name_en: "Luxury Studio",
      ...
      { id: 10, name_en: "Suite", name_ar: "جناح", category_id: 5 },

      // Duplex
      {
        id: 11,
        name_en: "Modern Duplex",
        name_ar: "دوبلكس حديث",
        category_id: 6,
      },
      ...
      {
        id: 12,
        name_en: "Sea View Penthouse",
        name_ar: "بنتهاوس على البحر",
        category_id: 7,
      },
    ],
    skipDuplicates: true,
